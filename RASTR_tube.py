...
def find_peak_2( array_1d, min_gap=80):
	...
	left_peak, right_peak = 0, len(array_1d_np)
	for diff, index in diff_list[:4]:
...
def main():
	...
	if results.subtraction:
		starfile = tube_subtraction( starfile, model_2d, results.output_rootname+'_subtracted.mrcs', separate=True, diameter_step=10)		
